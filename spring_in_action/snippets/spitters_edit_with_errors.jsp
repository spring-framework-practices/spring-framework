            ...
            <table cellspacing="0">
                <tr>
                    ...
                    <td><sf:input path="fullName" size="15"/><br/>
                        <sf:errors path="fullName" cssClass="error"/> <!--<co id="co_fullNameErrors"/>-->
                    </td>
                </tr>
                <tr>
                    ...
                    <td><sf:input path="username" size="15" maxlength="15"/>
                        ...
                        <br/>
                        <sf:errors path="username" cssClass="error"/> <!--<co id="co_userNameErrors"/>-->
                    </td>
                </tr>
                <tr>
                    ...
                    <td><sf:password path="password" size="30"
                        ...
                        <br/>
                        <sf:errors path="password" cssClass="error"/> <!--<co id="co_passwordErrors"/>-->
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td><sf:input path="email" size="30"/>
                        ...
                        <br/>
                        <sf:errors path="email" cssClass="error"/> <!--<co id="co_emailErrors"/>-->
                    </td>
                </tr>
                <tr>
                    <th></th>
